...
class TestProjectListPage(StaticLiveServerTestCase):
    ...
    def test_no_projects_alert_is_displayed(self):
        ...
        # user request the page for the first time
    ...
    def test_user_is_redirected_to_project_detail(self):
        project2 = Project.objects.create(name='project2', budget=2000)

        self.browser.get(self.live_server_url)

        # user sees the project list and clicks visit project button
        # then it will redirect to project detail page

        detail_url = self.live_server_url + reverse('detail',
                                                    args=[project2.slug])
